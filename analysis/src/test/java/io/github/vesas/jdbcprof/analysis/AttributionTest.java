...
class AttributionTest {
    ...
    void picksFirstNonExcludedFrame() {
        StackFrameSnapshot[] frames = {
                frame("io.github.vesas.jdbcprof.capture.StackTraceInternTable", "internCurrent", 58),
                frame("io.github.vesas.jdbcprof.capture.CaptureContext", "emit", 91),
                frame("io.github.vesas.jdbcprof.capture.CapturingPreparedStatement", "executeQuery", 52),
    ...
    void fallsBackToFirstNonJdkFrameWhenAllExcluded() {
        ...
        StackFrameSnapshot[] frames = {
                frame("io.github.vesas.jdbcprof.capture.CaptureContext", "emit", 1),
