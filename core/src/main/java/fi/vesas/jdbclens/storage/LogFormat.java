package fi.vesas.jdbclens.storage;
 ...
 * fixed at {@link #EVENT_BYTES} bytes — 65 bytes of payload plus 3
...
public final class LogFormat {
    ...
    /** Delta flush of {@link fi.vesas.jdbclens.capture.SqlInternTable} entries. */
    public static final byte REC_SQL_DELTA = 1;

    /** Delta flush of {@link fi.vesas.jdbclens.capture.StackTraceInternTable} entries. */
    ...
    /** Delta flush of {@link fi.vesas.jdbclens.capture.OperationInternTable} entries. */
    public static final byte REC_OP_DELTA = 5;

    /** Delta flush of {@link fi.vesas.jdbclens.capture.ParameterValuesInternTable} entries. */
