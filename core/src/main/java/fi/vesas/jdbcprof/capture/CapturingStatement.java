...
class CapturingStatement implements Statement {
    ...
    final void emitExecuteUnknown(int sqlId, long t0, long t1, boolean hasResultSet) throws SQLException {
        emitExecuteUnknown(sqlId, t0, t1, hasResultSet, 0L);
    }

    final void emitExecuteUnknown(int sqlId, long t0, long t1, boolean hasResultSet,
                                  long parameterFingerprint) throws SQLException {
        if (hasResultSet) {
